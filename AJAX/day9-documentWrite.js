...
users.data.forEach(element => {
    ...
    // console.log(el.avatar) // Here we will get all the data in Terminal
    ...
    document.write(`<img src=${element.avatar}>`) // ReferenceError: document is not defined
});



// node AJAX\day9-documentWrite.js